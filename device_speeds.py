# def ticks_to_items_per_second(ticks: int) -> float:
#     """
#     Converts ticks per operation to items per second.
#     Factorio simulation runs at 60 ticks per second.
#     """
#     if ticks <= 0:
#         return 0.0
#     return 60.0 / ticks

# # A direct mapping of Device Name -> Base Ticks per Cycle
# # Assemblers: Ticks to craft a recipe with a 1.0 second base time.
# # Inserters: Ticks for a full Chest-to-Chest swing (Extension + Rotation + Retraction).
# DEVICE_SPEEDS = {
#     # --- Assemblers ---
#     # Formula: 60 ticks / Crafting Speed
#     "assembling-machine-1": 120,  # Speed 0.5
#     "assembling-machine-2": 80,   # Speed 0.75
#     "assembling-machine-3": 48,   # Speed 1.25
    
#     # --- Inserters ---
#     # Values represent one full swing cycle (Chest-to-Chest)
#     # "burner-inserter": 76,
#     "inserter": 70,
#     "long-handed-inserter": 50,
#     "fast-inserter": 24,
#     # "stack-inserter": 24,  # Same motor speed as fast inserter
#     # "bulk-inserter": 24    # (Factorio 2.0 / Mod variant)
# }

# def get_device_metrics(device_name: str):
#     """
#     Looks up the device and prints its Ticks/Item and Items/Second.
#     Handles basic string normalization (spaces, case).
#     """
#     # Normalize input: "Fast Inserter" -> "fast-inserter"
#     key = device_name.lower().strip().replace(" ", "-")
    
#     if key in DEVICE_SPEEDS:
#         ticks = DEVICE_SPEEDS[key]
#         ips = ticks_to_items_per_second(ticks)
        
#         print(f"Device: {device_name}")
#         print(f"  - Speed: {ticks} ticks/cycle")
#         print(f"  - Rate:  {ips:.2f} operations/sec")
#         return ticks
#     else:
...
#     # specific lookups
#     get_device_metrics("Assembling Machine 3")
#     get_device_metrics("Fast Inserter")




# Device production/operation rates in operations per second
# For assemblers/furnaces: This is the crafting speed multiplier
# For inserters: This is items moved per second (for single items)
# For miners: This is the mining speed
